...
describe('Lib/Ripple', () => {
  ...
  describe('#checkSeedPhrase', () => {
    const seedPhrase = 'wolf extra expand cause vocal worth cricket era board word ability limit';
    ...
    context('with mainnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        before((done) => {
           ...
           */
          const masterPrivateKey = { masterPrivateKey: 'xprv9s21ZrQH143K322zF5PBbG4mLk3nbh3rnqRqPac9tBMp2beRCtNb4qPTztmyarBnw61ncV8WXJZaHagB9tSTdz91gCr9MbHwJaoefXGxEhi' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/144'/0'/0/2",
              address: 'X75QNrsgYw2mNt1uV7vXCNNCR3DTzzgWPFb5VTc1U6ii5iJ',
              publicKey: '02d12ff6f0db434aa2f4ea4c4893a8ebcc81ca4ec36bdde8c8348e927e38f2c547',
              privateKey: 'L2YwKqBH4Q7KfToXiGrGqQXYkhpsXVd59t9zojxyy95L2yuvEpGi'
            }
          ]
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K322zF5PBbG4mLk3nbh3rnqRqPac9tBMp2beRCtNb4qPTztmyarBnw61ncV8WXJZaHagB9tSTdz91gCr9MbHwJaoefXGxEhi',
              { limit: 1, skip: 1 }]);
          });
        })
      })
      context('with masterPublicKey', () => {
        ...
        before((done) => {
           ...
           * Generated By: https://iancoleman.io/bip39/
           */
          const masterPublicKey = { masterPublicKey: 'xpub67vnTn18WV2mrUVgbYdKaiY136m5eueGc5Efq8Utzx9hUKYwGG4RwpxegfdpZSvY8katKucKDFVFsyB8hVHyUd2bZNNKZJEq6uAY8xHBjKA' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/144'/0'/0/2",
              address: 'XVCsL2ZCTcas2acZNxcWVt5Hb9nbnLT4UjW7dZ6G7HAiHzZ',
              publicKey: '028c65680c55077114d0c34221a2154e4659f27d0839791ee13fbd0a0711c85441',
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xpub67vnTn18WV2mrUVgbYdKaiY136m5eueGc5Efq8Utzx9hUKYwGG4RwpxegfdpZSvY8katKucKDFVFsyB8hVHyUd2bZNNKZJEq6uAY8xHBjKA',
              { limit: 1, skip: 1 }]);
          });
        })
      })
      context('with seedPhrase', () => {
        ...
        before((done) => {
           ...
           * Generated By: https://iancoleman.io/bip39/
           */
          const seedPhrase = { seedPhrase: 'oval gather baby voyage second ritual awake sentence leader float punch wish dose concert whale' }
    ...
    context('with testnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: 'X7dEPNo7dX2gmZ1pWLiocnqvUzfvqkUMKPZaHYFc3ncmLx8',
      ...
      context('with masterPublicKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: 'XVEu4JT6p9YJedsuCziTFN6LZcb5VoqGhG5HrdajcYZqkLd',
      ...
      context('with seedPhrase', () => {
        ...
        before((done) => {
           ...
           * Generated By: https://iancoleman.io/bip39/
           */
          const seedPhrase = { seedPhrase: 'pause hawk click gadget ivory tent feature poverty manage ivory innocent stand debate veteran penalty' }
          ...
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '037798ec55401dabd54919296a51ccf607dd4087cc596fa8d65a6b55cb0524034d',
              privateKey: 'cTbsDzjtRmxoVVjKjLFCwTpV5YaaHfbVcEbyMJHT1hcmSbEcWZ5E'
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
  ...
  describe('#sign', () => {
    ...
    context('with testnet network', () => {
      ...
      it('should be return `304402203E7B99740A0ABD9B2AFC9A0B686EEB0D7A00057253D88735682A4B65FF4B1653022057C400B464FF0F1A570BF0B73F0076D2DACB2ED43E4739D5FB675C6337210242`', () => {
        assert.strictEqual(actual, '304402203E7B99740A0ABD9B2AFC9A0B686EEB0D7A00057253D88735682A4B65FF4B1653022057C400B464FF0F1A570BF0B73F0076D2DACB2ED43E4739D5FB675C6337210242');
      });
      try {
  ...
  describe('#getAddressFromPublic', () => {
    describe('with mainnet network', () => {
      ...
      context('with classic format', () => {
        const actual = instance.getAddressFromPublic(publicKey, 'classic');
        it(`should be return rQEbEkWa4RVdaSZiM3RveKSusujAE8xvbX`, () => {
          assert.strictEqual(actual, 'rQEbEkWa4RVdaSZiM3RveKSusujAE8xvbX');
        });
        try {
    ...
    describe('with testnet network', () => {
      ...
      context('without specifying format', () => {
        ...
        it(`should be return X7dEPNo7dX2gmZ1pWLiocnqvUzfvqkUMKPZaHYFc3ncmLx8`, () => {
          assert.strictEqual(actual, 'X7dEPNo7dX2gmZ1pWLiocnqvUzfvqkUMKPZaHYFc3ncmLx8');
        });  
      })
      context('with classic format', () => {
        const actual = instanceWithTestnet.getAddressFromPublic(publicKey, 'classic');
        it(`should be return rsyeJ68pbn9TGgquCtrn4CD9dd4tHn8pgx`, () => {
          assert.strictEqual(actual, 'rsyeJ68pbn9TGgquCtrn4CD9dd4tHn8pgx');
        });
        try {
  ...
  context('with testnet network', () => {
    const actual = instanceWithTestnet.checkSign('02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d', 'fake_data', '304402203E7B99740A0ABD9B2AFC9A0B686EEB0D7A00057253D88735682A4B65FF4B1653022057C400B464FF0F1A570BF0B73F0076D2DACB2ED43E4739D5FB675C6337210242');
    it('should be return `true`', () => {
      assert.strictEqual(actual, true);
    });
  })
