...
describe('Lib/EOS', () => {
    ...
    context('with mainnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        before((done) => {
           ...
           */
          const masterPrivateKey = { masterPrivateKey: 'xprv9s21ZrQH143K4LeEx2APdhYcizQf1yTEERrB6TtpAjhH76kiRWNWUccfpQsTe1w5ehpu62FdMfoy47ntcPK772qwEGUjZkzuXh31v5Um6ie' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/194'/0'/0/2",
              address: 'EOS87oAHjey1Hy5Qcod56MBgCSSaYQ52DfekSWsqdku3VckVaw2y5',
              publicKey: 'EOS87oAHjey1Hy5Qcod56MBgCSSaYQ52DfekSWsqdku3VckVaw2y5',
              privateKey: '5JJLUNPjAvJ1X3toeJLXSTk7Do8h9DmC6UnpqmF2SmnSd61upcr'
            }
          ];
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K4LeEx2APdhYcizQf1yTEERrB6TtpAjhH76kiRWNWUccfpQsTe1w5ehpu62FdMfoy47ntcPK772qwEGUjZkzuXh31v5Um6ie',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with masterPublicKey', () => {
        ...
        before((done) => {
           ...
           * Generated By: https://iancoleman.io/bip39/
           */
          const masterPublicKey = { masterPublicKey: 'xpub6G1LhBJRwLPWGn2wGdP8SpBpKSQSL8bVwbzbuADCw1DohkBWCKzi9H4T2uaSDxG77U6DNmPCBSWX7kpaPnUMbQnaox9MjJYjSiUeDrzqudC' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/194'/0'/0/2",
              address: 'EOS7yx1h4wrdrkxwrMjAb75RDLJdXy1dAuCaS18xCqayRdwWrzZ1Q',
              publicKey: 'EOS7yx1h4wrdrkxwrMjAb75RDLJdXy1dAuCaS18xCqayRdwWrzZ1Q'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xpub6G1LhBJRwLPWGn2wGdP8SpBpKSQSL8bVwbzbuADCw1DohkBWCKzi9H4T2uaSDxG77U6DNmPCBSWX7kpaPnUMbQnaox9MjJYjSiUeDrzqudC',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with seedPhrase', () => {
        ...
        before((done) => {
           ...
           * Generated By: https://iancoleman.io/bip39/
           */
          const seedPhrase = { seedPhrase: 'december carry bless goose surge object reduce tomato chef hollow box drill name answer tumble' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/194'/0'/0/2",
              address: 'EOS7MFWdhfMYSLN3gK48Ucx3ob4i28SZ5MfdgzfA8Xvz4KYkyjfAj',
              publicKey: 'EOS7MFWdhfMYSLN3gK48Ucx3ob4i28SZ5MfdgzfA8Xvz4KYkyjfAj',
              privateKey: '5HuwRWZYCgcbwemoFn2D2KTmqCyKXzYWjr51qCDeTmSytcabmh5'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K2jPo7ik5Wq7V5vx5J8zDALgyzgn9YDHjLwnMWbiVW6Ja7z1yHkQmpkRifgLVPouF2AaU9KgaBXAohpN7QPNPPmi4DNu6bsd',
              { limit: 1, skip: 1 }]);
          });
        });
      })
    ...
    context('with testnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: 'EOS6NSj1rroK1cXLve4pXW5YRUVYrk7c7L59GFRrribSgy9FpV8Xm',
              publicKey: 'EOS6NSj1rroK1cXLve4pXW5YRUVYrk7c7L59GFRrribSgy9FpV8Xm',
              privateKey: '5KP4XRfzMTcqnMcDmq2MVp8ApoQTUi12D6Cep55gHsTbctvMYA8'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
      ...
      context('with masterPublicKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: 'EOS6o2wL5XTqo58fWwHFM5YMuUxXGRqZCEtFx9yaJVJ2uQWZsniVP',
              publicKey: 'EOS6o2wL5XTqo58fWwHFM5YMuUxXGRqZCEtFx9yaJVJ2uQWZsniVP'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
      ...
      context('with seedPhrase', () => {
        ...
        before((done) => {
           ...
           * Generated by: https://iancoleman.io/bip39/
           */
          const seedPhrase = { seedPhrase: 'cruise quick regular reward arrow rich exercise chair mad slim flame creek aerobic airport oak' }
          ...
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '0220f62994c468d5a407e26c41760a9cec5d5359743c7a34ae6fbcdd5726da3c82',
              privateKey: 'cW5BJw2xfZXmaMdcjwnae4SgXAQPPuPc2xjTZs2FqZTQ7r3nCv7y'
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
  ...
  describe('#sign', () => {
    ...
    context('with testnet network', () => {
      const privateKey = '5KP4XRfzMTcqnMcDmq2MVp8ApoQTUi12D6Cep55gHsTbctvMYA8';
      ...
      it(`should be return SIG_K1_JyQ7zkQgv4GN6PaxvgTRUUuXQGPbfXDvwJNio4G1cTRqkBoP39vKswaX9BPffj1aZDaYw9f4pZPP8XYX8Xj5spdoL84dBJ`, () => {
        assert.strictEqual(actual, 'SIG_K1_JyQ7zkQgv4GN6PaxvgTRUUuXQGPbfXDvwJNio4G1cTRqkBoP39vKswaX9BPffj1aZDaYw9f4pZPP8XYX8Xj5spdoL84dBJ');
      });
      try {
  ...
  describe('#getPublicFromPrivate', () => {
    ...
    context('with testnet network', () => {
      ...
      it(`should be return EOS6NSj1rroK1cXLve4pXW5YRUVYrk7c7L59GFRrribSgy9FpV8Xm`, () => {
        assert.strictEqual(actual, 'EOS6NSj1rroK1cXLve4pXW5YRUVYrk7c7L59GFRrribSgy9FpV8Xm');
      });
      try {
  ...
  describe('#getAddressFromPublic', () => {
    ...
    describe('with testnet network', () => {
      const publicKey = 'EOS6o2wL5XTqo58fWwHFM5YMuUxXGRqZCEtFx9yaJVJ2uQWZsniVP';
      context('Without specifing format', () => {
        ...
        it(`should be return EOS6o2wL5XTqo58fWwHFM5YMuUxXGRqZCEtFx9yaJVJ2uQWZsniVP`, () => {
          assert.strictEqual(actual, 'EOS6o2wL5XTqo58fWwHFM5YMuUxXGRqZCEtFx9yaJVJ2uQWZsniVP');
        });
        try {
  ...
  describe('#checkSign', () => {
    ...
    context('with testnet network', () => {
      const actual = instanceWithTestnet.checkSign('EOS6NSj1rroK1cXLve4pXW5YRUVYrk7c7L59GFRrribSgy9FpV8Xm', 'fake_data', 'SIG_K1_JyQ7zkQgv4GN6PaxvgTRUUuXQGPbfXDvwJNio4G1cTRqkBoP39vKswaX9BPffj1aZDaYw9f4pZPP8XYX8Xj5spdoL84dBJ');
      it('should be return `true`', () => {
        assert.strictEqual(actual, true);
      });
      try {
        instanceWithTestnet.checkSign('EOS6NSj1rroK1cXLve4pXW5YRUVYrk7c7L59GFRrribSgy9FpV8Xm', 'fake_data', 'invalid_sign');
      } catch (ex) {
        it('should be throw an error with following message `Expecting signature like: SIG_K1_base58signature..`', () => {
          assert.strictEqual(ex.message, 'Expecting signature like: SIG_K1_base58signature..');
        });
