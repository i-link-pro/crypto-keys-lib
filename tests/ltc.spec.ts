...
describe('Lib/Litecoin', () => {
    ...
    context('with mainnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        before((done) => {
           ...
           */
          const masterPrivateKey = { masterPrivateKey: 'xprv9s21ZrQH143K2ipfB4dMesTX5mCbYqUSQuznQffV3x28noGDwU9La12RcJa8HYFaKVw96By7THGttKo9N7YyKDTGfcYUJKXBkJHy58Xpgpi' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '0230ff744a623c4edf734ed732cf595962f4d293b0bd69493da6a0c4f19595797f',
              privateKey: 'TB29KmPEkUk68pBtYBPBXtQuZQL1izukct4tiUWqq1y7FdDK3xge'
            }
          ]
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K2ipfB4dMesTX5mCbYqUSQuznQffV3x28noGDwU9La12RcJa8HYFaKVw96By7THGttKo9N7YyKDTGfcYUJKXBkJHy58Xpgpi',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with masterPublicKey', () => {
        ...
        before((done) => {
           ...
           * Generated by: https://iancoleman.io/bip39/
           */
          const masterPublicKey = { masterPublicKey: 'xpub6ADEEufzPwGvd9iMW3QPB9p9WdpoD1nZx4YZmJbSbTpAjKj39vsbW2THocpT17LtQCvHp4QGR2HfNJrY9H7s3xSdc39WBQEoJDnGsj8UVni' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              ...
              publicKey: '02d57ecb8a2017321151b79156ed24aa1762d47e76c542e7a91873d99ce8164922',
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xpub6ADEEufzPwGvd9iMW3QPB9p9WdpoD1nZx4YZmJbSbTpAjKj39vsbW2THocpT17LtQCvHp4QGR2HfNJrY9H7s3xSdc39WBQEoJDnGsj8UVni',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with seedPhrase', () => {
        ...
        before((done) => {
           ...
           * Generated by: https://iancoleman.io/bip39/
           */
          const seedPhrase = { seedPhrase: 'bench ozone atom antenna odor fatal ride intact arch valve drop mule isolate toss steel' }
          ...
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '03a60b3187c2df3af16e47005d0cb927fc51cb45ff08594e1398920779c305fe2c',
              privateKey: 'T957EsWcg5kjgWiHHgjMgA9SQymXo5Jk8rKyKw7Yko9RMb245Cgo'
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
    ...
    context('with testnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        before((done) => {
           ...
           * Generated by: https://iancoleman.io/bip39/
           */
          const masterPrivateKey = { masterPrivateKey: 'tprv8ZgxMBicQKsPdx9HgB7ktcK3XED6iacamShaTuiFjidXVLyQR1HqSvCnaprtW1jUwVVKWFbgFqTUrwXP3w89RHF2UiEcuQ8u96Yu8U2qzaX' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '02b1fd5ed7cdb46009043adff31c92e9d0cd814df78f4774d098d11b067d88957f',
              privateKey: 'cTaLMV6VEVnt2igKhCzYDPPmA3Rbax8ttFxqBtuBzKS8fPngUmb2'
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['tprv8ZgxMBicQKsPdx9HgB7ktcK3XED6iacamShaTuiFjidXVLyQR1HqSvCnaprtW1jUwVVKWFbgFqTUrwXP3w89RHF2UiEcuQ8u96Yu8U2qzaX',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with masterPublicKey', () => {
        ...
        before((done) => {
           ...
           * Generated by: https://iancoleman.io/bip39/
           */
          const masterPublicKey = { masterPublicKey: 'tpubDHUsrHqi3VfStvjecN1UpjKjfZNYaTkr2C8oabhchCxtA5YWNj3VjL8ffk5LNz3CZTxzrTHfWWr1z2Dnf7kM4RexwrFcfFcTpMXAQACzM9x' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              ...
              publicKey: '03110a653ad0c380f2f070fc77ba76cf52e480d154feffcb6c7c825fbfca5740a0',
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['tpubDHUsrHqi3VfStvjecN1UpjKjfZNYaTkr2C8oabhchCxtA5YWNj3VjL8ffk5LNz3CZTxzrTHfWWr1z2Dnf7kM4RexwrFcfFcTpMXAQACzM9x',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with seedPhrase', () => {
        ...
        before((done) => {
           ...
           * Generated by: https://iancoleman.io/bip39/
           */
          const seedPhrase = { seedPhrase: 'lake trade arrest shiver used lucky collect caution monitor polar dress earn coast myself unique' }
          ...
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '034243f24045d256ddfd466ea40455a61991a7dc96f54632e3fe5ea6143915413f',
              privateKey: 'cR1eRQB2sysfKE2A9tWLqv4NzaKiXu2QMyVTEpksNiqzPTv7UtLz'
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
  ...
  describe('#derivateKeys/errorHandling', () => {
    ...
    try {
      ...
      masterPrivateKey.masterPrivateKey = 'xprv9u1dytnk36qHsh7hbmdo8m74zPL7UYeqUvnQfDDRJWH2myRzqmiGGmhnvVEyVomnTzTATLyfJviRhTH8YJuqUBmvC9UTzYdWd15ut3w4dYJ';
      instance.derivateKeys(masterPrivateKey, cursor); // check behavior in case of negative limit
    } catch (ex) {
  ...
  describe('#sign', () => {
    ...
    context('with testnet network', () => {
      const privateKey = 'cTaLMV6VEVnt2igKhCzYDPPmA3Rbax8ttFxqBtuBzKS8fPngUmb2';
      ...
      it('should be return `400915601b1ddda07b745bf582c55519d1b6a33ce1549ab91e56e9f59513e4167e47779d4bcfa4c62e9408b87ac0dc341cf52b9b0af60949f4d8ce7e03b17d52`', () => {
        assert.strictEqual(actual, '400915601b1ddda07b745bf582c55519d1b6a33ce1549ab91e56e9f59513e4167e47779d4bcfa4c62e9408b87ac0dc341cf52b9b0af60949f4d8ce7e03b17d52');
      });
      try {
        instance.sign('fake_data', 'Invalid_Private_Key'); // check behavior in case of invalid private Key
      } catch (ex) {
  ...
  describe('#getPublicFromPrivate', () => {
    ...
    context('with testnet network', () => {
      ...
      it(`should be return 02b1fd5ed7cdb46009043adff31c92e9d0cd814df78f4774d098d11b067d88957f`, () => {
        assert.strictEqual(actual, '02b1fd5ed7cdb46009043adff31c92e9d0cd814df78f4774d098d11b067d88957f');
      });
      try {
  ...
  describe('#getAddressFromPublic', () => {
    describe('with mainnet network', () => {
      ...
      context('Without bech32 format', () => {
        ...
        it(`should be return tltc1qktmq2uwmt2shqlrz334jva35fhtvcpff5fuk02`, () => {
          assert.strictEqual(actual, 'tltc1qktmq2uwmt2shqlrz334jva35fhtvcpff5fuk02');
        });
      })
    ...
    describe('with testnet network', () => {
      const publicKey = '02b1fd5ed7cdb46009043adff31c92e9d0cd814df78f4774d098d11b067d88957f';
      context('Without specifing format', () => {
        const actual = instanceWithTestnet.getAddressFromPublic(publicKey);
        it(`should be return mrtHJyjAv8Jc7zqg35FqjyYenUnWdUERyX`, () => {
          assert.strictEqual(actual, 'mrtHJyjAv8Jc7zqg35FqjyYenUnWdUERyX');
        });
        try {
      ...
      context('Without bech32 format', () => {
        ...
        it(`should be return ltc1q0jclu959l9wephzy04yzx7ejsdpv9fd58yw58z`, () => {
          assert.strictEqual(actual, 'ltc1q0jclu959l9wephzy04yzx7ejsdpv9fd58yw58z');
        });
      })
      context('Without invalid format', () => {
  ...
  describe('#checkSign', () => {
    ...
    context('with testnet network', () => {
      const actual = instanceWithTestnet.checkSign('02b1fd5ed7cdb46009043adff31c92e9d0cd814df78f4774d098d11b067d88957f', 'fake_data', '400915601b1ddda07b745bf582c55519d1b6a33ce1549ab91e56e9f59513e4167e47779d4bcfa4c62e9408b87ac0dc341cf52b9b0af60949f4d8ce7e03b17d52');
      it('should be return `true`', () => {
        assert.strictEqual(actual, true);
      });
      try {
        instanceWithTestnet.checkSign('02b1fd5ed7cdb46009043adff31c92e9d0cd814df78f4774d098d11b067d88957f', 'fake_data', 'invalid_sign');
      } catch (ex) {
        it('should be throw an error with following message `Expected Signature`', () => {
          assert.strictEqual(ex.message, 'Expected Signature');
        });
