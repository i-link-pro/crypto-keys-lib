...
describe('Lib/Ethereum', () => {
      ...
      context('with masterPublicKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/60'/0'/0/2",
              address: '0x9D7f17998eA70CFCF8a31e421d04EBa1ee5A881d',
              publicKey: '0x03589ba6d047be9acf960f3a204be09f288245768db2de3dd62704fe24730b5ebf'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
      ...
      context('with seedPhrase', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/60'/0'/0/2",
              address: '0x5ad3934232A07557C6Dfc103C05C2922A31c2745',
              publicKey: '0x03c4f1ab021b9293d5151ad9fb725f0c3768792af6e552707cf9fbf35f7bcadd5c',
              privateKey: '0xe0962b8fcfaca22674fb870fc3b96d425a64f756dc130b6f68a10ab57847841e'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
    ...
    context('with testnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: '0xe747482b2ddfF3830141c3d409327C7276871366',
              publicKey: '0x02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d',
              privateKey: '0xce1d919795a87346b29aeb11bdd95f9608169ed9dc2e60c4dd81d43dd6b69949'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
      ...
      context('with masterPublicKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: '0x937d3d8034f13b9B67DfcCE7f93b0f23aA83DB8A',
              publicKey: '0x02fb0142a7e11401073a01dc913f30755bfb082c6197347f146d42db6455eabd03'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
      ...
      context('with seedPhrase', () => {
        ...
        before((done) => {
           ...
           * Generated by: https://iancoleman.io/bip39/
           */
          const seedPhrase = { seedPhrase: 'height utility own gossip draft anxiety gesture leader online vacuum other tuna pitch cry anger' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: '0x5e9048408d084D6FC80591139C6e0AFc0DBe061f',
              publicKey: '0x039fa838fe66f379578e3165117ce0c95b6a0172c6ab3ffd922a4da749fdcea2b6',
              privateKey: '0x80f7fda49ebb91f8890ee103fa258d3aa13de8d6339e43a4d6e7ea9a4bd30cba'
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
  ...
  describe('#sign', () => {
    ...
    context('with testnet network', () => {
      const privateKey = '0xce1d919795a87346b29aeb11bdd95f9608169ed9dc2e60c4dd81d43dd6b69949';
      ...
      it(`should be return {"r":"0a1da94b81da9e5a735a398f7158a67ac0eaeab785c90d6fed10875cff053d1d","s":"78b642fdc963087102675884d694650543b8cd081ee49380e823c86cb2332c25","v":27}`, () => {
        assert.strictEqual(actual, '{"r":"0a1da94b81da9e5a735a398f7158a67ac0eaeab785c90d6fed10875cff053d1d","s":"78b642fdc963087102675884d694650543b8cd081ee49380e823c86cb2332c25","v":27}');
      });
      try {
  ...
  describe('#getPublicFromPrivate', () => {
    ...
    context('with testnet network', () => {
      ...
      it(`should be return 0x02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d`, () => {
        assert.strictEqual(actual, '0x02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d');
      });
      try {
  ...
  describe('#getAddressFromPublic', () => {
    ...
    context('Without testnet network', () => {
      const publicKey = '0x03c4f1ab021b9293d5151ad9fb725f0c3768792af6e552707cf9fbf35f7bcadd5c';
      ...
      it(`should be return 0x5ad3934232A07557C6Dfc103C05C2922A31c2745`, () => {
        assert.strictEqual(actual, '0x5ad3934232A07557C6Dfc103C05C2922A31c2745');
      });
      try {
  ...
  describe('#checkSign', () => {
    ...
    context('with testnet network', () => {
      const actualPositive = instanceWithTestnet.checkSign('0x02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d', 'fake_data', '{"r":"0a1da94b81da9e5a735a398f7158a67ac0eaeab785c90d6fed10875cff053d1d","s":"78b642fdc963087102675884d694650543b8cd081ee49380e823c86cb2332c25","v":27}');
      it('should be return `true`', () => {
        assert.strictEqual(actualPositive, true);
      });
      try {
        instanceWithTestnet.checkSign('Invalid_Public_Key', 'fake_data', '{"r":"0a1da94b81da9e5a735a398f7158a67ac0eaeab785c90d6fed10875cff053d1d","s":"78b642fdc963087102675884d694650543b8cd081ee49380e823c86cb2332c25","v":27}'); // check behavior in case of invalid public Key
      } catch (ex) {
      ...
      try {
        instanceWithTestnet.checkSign('0x02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d', 'fake_data', 'invalid_sign');
      } catch (ex) {
        it('should be throw an error with following message `Unexpected token i in JSON at position 0`', () => {
          assert.strictEqual(ex.message, 'Unexpected token i in JSON at position 0');
        });
