...
describe('Lib/BitcoinSV', () => {
    const instance = new Keys(Blockchain.BSV, Network.MAINNET)
    const instanceWithTestnet = new Keys(Blockchain.BSV, Network.TESTNET)
    ...
    describe('#sign', () => {
        context('with testnet network', () => {
            ...
            it('signs correct transaction', async () => {
                const transaction =
                    '{"sum":"0.00001","fee":"134","inputs":[{"txId":"a3614889a4ec8f68e9d3f18d47f95f6eed0abfcfb4907c900bf2aaab74c8aab5","hex":"","n":0,"value":"9000000","address":"muTeE2BQVWwhP6hK7aGN8Hy8HnkrhNxH2M","type":"pubkeyhash","scriptPubKeyHex":"76a91498f16ded439fef02517e4b8b35ffb5f4e207f7f488ac"}],"outputs":[{"address":"mmdnUVZPYqbDDWL6ofoKDsKj88wvGWkbJ5","amount":"1000"},{"address":"mquGEzwExar415QREP1fPoQcUEaFZ9Vwdq","amount":"8998866"}]}'
                const keysMap = {
                    muTeE2BQVWwhP6hK7aGN8Hy8HnkrhNxH2M:
                        'Kyibmf4L1zjZfHbypdxJ3oFyq7iPJoDuqajdWMzcr27zf9Xp2bcN',
                }
    ...
    describe('#signTx', () => {
        context('with testnet network', async () => {
            ...
            it('should be return ``', () => {
                assert.strictEqual(
                    actual,
                    '',
                )
            })
            try {
                await instanceWithTestnet.sign(
