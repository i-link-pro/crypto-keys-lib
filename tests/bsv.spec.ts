...
describe('Lib/BitcoinSV', () => {
          ...
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '027823acf3b6bc74a8de81a0f8a0f9f76bb10c47a70bc3a268e29ee0b3c8bbc40e',
              privateKey: 'KwYBu6woqHQeiBMx6194c9AVhL8hKgpxcoNEsSLmRDbUM8wkkZuP'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
    ...
    context('with testnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        before((done) => {
           ...
           * Generated By: https://iancoleman.io/bip39/
           */
          const masterPrivateKey = { masterPrivateKey: 'xprv9s21ZrQH143K2iKVu6HAL1Fzuo8fDw15ZKXrNeshMyem7yyG5th14TdjX1rgdZoM3pCByNskZmxDs58NPSCgmTjSYWunLKvBiu2LznJw6K9' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '024b6bcf5552d193cda04ba9d129503a6318b5bd98c1a42cdc49e0a98b53a24796',
              privateKey: 'KxXoNWFRuNJgfk1GrHaHVBXccH9qVPsNMnjGUHKR6FR31HtcBvLk'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          it(`should be call {derivateFromPrivate} function with following args 
              ...
              { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K2iKVu6HAL1Fzuo8fDw15ZKXrNeshMyem7yyG5th14TdjX1rgdZoM3pCByNskZmxDs58NPSCgmTjSYWunLKvBiu2LznJw6K9',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with masterPublicKey', () => {
        ...
        before((done) => {
           ...
           * Generated By: https://iancoleman.io/bip39/
           */
          const masterPublicKey = { masterPublicKey: 'xpub6BSVpjECmShCyKGVRbFALyug71W5xwsf5A7tyxh9FyujZDRNUyfzBuu3UpRTFNS3YWK7uAajq9KPMe7hzbBd8Rrt1x6A24zMhGSTt72exx1' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              ...
              publicKey: '024b7a3f27b92d656cc63a2ebd5cb4372f7927ae6ea7f9bc786a793a4c9aa5d8a5'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          it(`should be call {derivateFromPublic} function with following args 
              ...
              { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xpub6BSVpjECmShCyKGVRbFALyug71W5xwsf5A7tyxh9FyujZDRNUyfzBuu3UpRTFNS3YWK7uAajq9KPMe7hzbBd8Rrt1x6A24zMhGSTt72exx1',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with seedPhrase', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              privateKey: 'L5HbYe7sDS7Cu8e49yoCKcopAcXRD4p3Wciqke2BCeE9XCbmxtnj'
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K2MyXcUrt7THG8CM5mcfzUfRqv6bMjD529SexMiJUWNeKqnqJDvFwzWtht7KqCdtdPPSVmWHDGKP3dYse2Gysn8Eun2yvtmb',
              { limit: 1, skip: 1 }]);
          });
        });
      })
  ...
  describe('#sign', () => {
    ...
    context('with testnet network', () => {
      const privateKey = 'KxXoNWFRuNJgfk1GrHaHVBXccH9qVPsNMnjGUHKR6FR31HtcBvLk';
      ...
      it(`should be return 716c12a248071f782fe47212e1d8e7b729e361044213cf2a18aed5ae90c920885dbb57096312a228dedaa846896ac0e516f51d8daeb853413251a7a914541946`, () => {
        assert.strictEqual(actual, '716c12a248071f782fe47212e1d8e7b729e361044213cf2a18aed5ae90c920885dbb57096312a228dedaa846896ac0e516f51d8daeb853413251a7a914541946');
      });
      try {
  ...
  describe('#getPublicFromPrivate', () => {
    ...
    context('with testnet network', () => {
      ...
      it(`should be return 024b6bcf5552d193cda04ba9d129503a6318b5bd98c1a42cdc49e0a98b53a24796`, () => {
        assert.strictEqual(actual, '024b6bcf5552d193cda04ba9d129503a6318b5bd98c1a42cdc49e0a98b53a24796');
      });
      try {
    ...
    describe('with mainnet network', () => {
      ...
      context('With bech32 format', () => {
        ...
        it(`should be return bsv1qxwf36pt6445fczypgf3ggqveeyaez577l46jfp`, () => {
          assert.strictEqual(actual, 'bsv1qxwf36pt6445fczypgf3ggqveeyaez577l46jfp');
        });
        try {
          instance.getAddressFromPublic('Invalid_Public_Key'); // check behavior in case of invalid public Key
        } catch (ex) {
    ...
    describe('with testnet network', () => {
      ...
      context('Without specifing format', () => {
        ...
        it(`should be return 13yeJhn2b59TGgquft15NfD9ddNtH5n2gx`, () => {
          assert.strictEqual(actual, '13yeJhn2b59TGgquft15NfD9ddNtH5n2gx');
        });
        try {
      ...
      context('With bech32 format', () => {
        ...
        it(`should be return tbsv1qyzn2ltksd54s623q2f68qg6l5uv5qpvxmt3v08`, () => {
          assert.strictEqual(actual, 'tbsv1qyzn2ltksd54s623q2f68qg6l5uv5qpvxmt3v08');
        });
      })
  ...
  describe('#checkSign', () => {
    ...
    context('with testnet network', () => {
      const actualPositive = instanceWithTestnet.checkSign('024b6bcf5552d193cda04ba9d129503a6318b5bd98c1a42cdc49e0a98b53a24796', 'fake_data', '716c12a248071f782fe47212e1d8e7b729e361044213cf2a18aed5ae90c920885dbb57096312a228dedaa846896ac0e516f51d8daeb853413251a7a914541946');
      it('should be return `true`', () => {
        assert.strictEqual(actualPositive, true);
      });
      try {
        instanceWithTestnet.checkSign('Invalid_Public_Key', 'fake_data', '716c12a248071f782fe47212e1d8e7b729e361044213cf2a18aed5ae90c920885dbb57096312a228dedaa846896ac0e516f51d8daeb853413251a7a914541946'); // check behavior in case of invalid public Key
      } catch (ex) {
      ...
      try {
        instanceWithTestnet.checkSign('024b6bcf5552d193cda04ba9d129503a6318b5bd98c1a42cdc49e0a98b53a24796', 'fake_data', 'invalid_sign');
      } catch (ex) {
        it('should be throw an error with following message `Expected Signature`', () => {
          assert.strictEqual(ex.message, 'Expected Signature');
        });
