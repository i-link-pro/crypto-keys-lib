...
describe('Lib/BitcoinCash', () => {
  ...
  const instanceWithTestnet = new Keys(Blockchain.BITCOIN_CASH, Network.TESTNET);
      ...
      context('with masterPublicKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/145'/0'/0/2",
              address: 'bitcoincash:qqnpwxjq0unxnn4x9juejm0azswjddm9e5len205rx',
      ...
      context('with seedPhrase', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/145'/0'/0/2",
              address: 'bitcoincash:qz02e3r522fgts6n3u8g36yzfgs0grsclur3msdglj',
              publicKey: '03a64398508dd255a629073532be8d40dd2a2bc2c7ff6061281615b2ad637f9797',
              privateKey: 'KxjbCqTzfHbUiXoLrjSH1JfWhFx2z6KJnLm2cfhgdt8kvoZhUnoU'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
      ...
      context('with masterPrivateKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: 'bchtest:qqs2dtaw6pkjkrf2ypf8guprt7n3jsq9scjy3fjlwr',
      ...
      context('with masterPublicKey', () => {
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/1'/0'/0/2",
              address: 'bchtest:qzwq4c99qgmst0pc93kzanna0ucjmguaws0nj0ulps',
    ...
    describe('with testnet network', () => {
      ...
      context('Without specifing format', () => {
        ...
        it(`should be return bchtest:qqs2dtaw6pkjkrf2ypf8guprt7n3jsq9scjy3fjlwr`, () => {
          assert.strictEqual(actual, 'bchtest:qqs2dtaw6pkjkrf2ypf8guprt7n3jsq9scjy3fjlwr');
        });
        try {
