...
describe('Lib/BitcoinBase', () => {
    ...
    context('with mainnet network', () => {
      ...
      context('with masterPrivateKey', () => {
        ...
        before((done) => {
          ...
          const masterPrivateKey = { masterPrivateKey: 'xprv9s21ZrQH143K3VDSXCXAqm4Wkw7TXBHfkxmaJ7RLRjqFADEeB7CiRjbfz7pxM8uzGFDcmAgz3jfAm2f88FSRFMKGGZeVo1qCpnSdFtXzeHt' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '03c8c63066b53f1ece9652084115fd67bf02f37785944b604da73bc9384333acc5',
              privateKey: 'KxmUfeuHWUXBpHXkHhmkRNiF7MZQhFL3gzGC9fNCzPVxg8MXAmV9'
            }
          ];
          ...
          it(`should be call {derivateFromPrivate} function with following args 
              ...
              { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K3VDSXCXAqm4Wkw7TXBHfkxmaJ7RLRjqFADEeB7CiRjbfz7pxM8uzGFDcmAgz3jfAm2f88FSRFMKGGZeVo1qCpnSdFtXzeHt',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with masterPublicKey', () => {
        ...
        before((done) => {
          ...
          const masterPublicKey = { masterPublicKey: 'xpub661MyMwAqRbcFkod8bRLkBLEpxJuHD1jdsLwzn2PsPLxs3YtAjyKPHFp4m4EssQC9aQNWymqLeKyhELT8MFKQFZgv8VBdrdVod1r9NtESMP' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              path: "m/44'/0'/0'/0/2",
              address: '14UQMUzbNPKqFjEeox5UGESLry3FK9catx',
              publicKey: '03589ba6d047be9acf960f3a204be09f288245768db2de3dd62704fe24730b5ebf'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          it(`should be call {derivateFromPublic} function with following args 
              ...
              { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xpub661MyMwAqRbcFkod8bRLkBLEpxJuHD1jdsLwzn2PsPLxs3YtAjyKPHFp4m4EssQC9aQNWymqLeKyhELT8MFKQFZgv8VBdrdVod1r9NtESMP',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with seedPhrase', () => {
        ...
        before((done) => {
          ...
          const seedPhrase = { seedPhrase: 'gossip that property quit spy emerge electric lazy twist couch phrase capable' }
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '028061621e6bf5b4377203f7a8edf6ecc5e418d86ddd92fb155f37cb266971b908',
              privateKey: 'Kz1bmHP5NPC4Y7oZaT2LzYqNgy8nVNzBr9As3w73FwxGQ2CtdyUj'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          it(`should be call {derivateFromPrivate} function with following args 
              ...
              { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K3GjA2ZtLP3PWGvUQskHtGeRMCPcnK3oyzFDjdCf4qUwLDVwnRkPnik2ssTpXAidRfZvgqzrcr1vEvvbknHtyjkeFZ5GZ6fo',
              { limit: 1, skip: 1 }]);
          });
        });
      })
    ...
    context('with testnet network', () => {
      context('with masterPrivateKey', () => {
        ...
        before((done) => {
           ...
           */
          const masterPrivateKey = { masterPrivateKey: 'tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK' }
          actual = instanceWithTestnet.derivateKeys(masterPrivateKey, cursor);
          done();
        })
        after((done): void => {
          sinon.restore();
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d',
              privateKey: 'cUVN2CtwaNBTUdRimGn6qVVhzD7wXk4nQQ6u1BU9vaNQ3oGKhKvw'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          it(`should be call {derivateFromPrivate} function with following args 
              ...
              { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with masterPublicKey', () => {
        ...
        before((done) => {
          ...
          const masterPublicKey = { masterPublicKey: 'tpubDCSJ3GrB3gss1K2ySF1pFezeSmdWZgjAXJC9i7mSVgh1taeg8XM6U522Tq1Yapd4yTn7BBzUzneZVDCLtyZxt42Js7YpVPqQXkTjKBTiytv' }
          actual = instanceWithTestnet.derivateKeys(masterPublicKey, cursor);
          done();
        })
        after((done): void => {
          sinon.restore();
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string }] = [
            {
              ...
              publicKey: '02fb0142a7e11401073a01dc913f30755bfb082c6197347f146d42db6455eabd03'
            }
          ];
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          it(`should be call {derivateFromPublic} function with following args 
              ...
              { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['tpubDCSJ3GrB3gss1K2ySF1pFezeSmdWZgjAXJC9i7mSVgh1taeg8XM6U522Tq1Yapd4yTn7BBzUzneZVDCLtyZxt42Js7YpVPqQXkTjKBTiytv',
              { limit: 1, skip: 1 }]);
          });
        });
      })
      context('with seedPhrase', () => {
        ...
        before((done) => {
           ...
           */
          const seedPhrase = { seedPhrase: 'include gas swallow valve dignity candy dragon voice member concert planet mutual dutch reform push' }
          actual = instanceWithTestnet.derivateKeys(seedPhrase, cursor);
          done();
        })
        after((done): void => {
          sinon.restore();
        ...
        context('positive result', () => {
          const expected: [{ path: string, address: string, publicKey: string, privateKey: string }] = [
            {
              ...
              publicKey: '02d7d7b4ed62a982c6bcdb8146230f9b92d4bd3a8136faaec49fbf8750261d82b7',
              privateKey: 'cVeb1Z7ieVoU4a7KYPcKgwJsnqppsWujaesJs4Ughkt9mwkSLETq'
            }
          ]
          it(`should be return correct ${expected[0]['path']} path`, () => {
            assert.strictEqual(actual[0]['path'], expected[0]['path']);
          ...
          { limit: 1, skip: 1 }]`, () => {
            assert.deepEqual(spy.args[0], ['xprv9s21ZrQH143K38um1cGFixh4D6ntV4aaRtnTbVHoFk93hkEKRdx5wAqLfehEVeMAa3xYW9yv6UsgQ5ydvinCcDyRx52KF3QrDzoUgpwvNZS',
              { limit: 1, skip: 1 }]);
          });
        });
      })
  ...
  describe('#sign', () => {
    context('with mainnet network', () => {
      const privateKey = 'L58PscmN5Ee1u2t4oCvZNq1YF9rtuwe19CospGwygyBfd3aH7zYy';
    ...
    context('with testnet network', () => {
      const privateKey = 'cUVN2CtwaNBTUdRimGn6qVVhzD7wXk4nQQ6u1BU9vaNQ3oGKhKvw';
      ...
      it(`should be return 1fac94bc837983a6569d42a46e6fa5156c2b23b3be9d4c90e1a68f804ed85d6e6b31b044f4b2eac5853d91d29e04bbb9f2f7b4d2a3465fe2ad2a0181abd345ca`, () => {
        assert.strictEqual(actual, '1fac94bc837983a6569d42a46e6fa5156c2b23b3be9d4c90e1a68f804ed85d6e6b31b044f4b2eac5853d91d29e04bbb9f2f7b4d2a3465fe2ad2a0181abd345ca');
      });
      try {
  ...
  describe('#getPublicFromPrivate', () => {
    ...
    context('with testnet network', () => {
      ...
      it(`should be return 02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d`, () => {
        assert.strictEqual(actual, '02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d');
      });
      try {
  ...
  describe('#getAddressFromPublic', () => {
    describe('with mainnet network', () => {
      ...
      context('With bech32 format', () => {
        const actual = instance.getAddressFromPublic(publicKey, 'bech32');
        it(`should be return bc1qan8h5sgtak8rh7nrd63dxafhfla7ghrnf6tgr9`, () => {
          assert.strictEqual(actual, 'bc1qan8h5sgtak8rh7nrd63dxafhfla7ghrnf6tgr9');
        });
      })

      context('With invalid format', () => {
        const actual = instance.getAddressFromPublic(publicKey, 'invalid');
        it(`should be return 1Nb924nRs93gWVeFnaKH1EE8uLqWGfdkXE`, () => {
          assert.strictEqual(actual, '1Nb924nRs93gWVeFnaKH1EE8uLqWGfdkXE');
        });
      })
    ...
    describe('with testnet network', () => {
      const publicKey = '02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d';
      context('Without specifing format', () => {
        const actual = instanceWithTestnet.getAddressFromPublic(publicKey);
        it(`should be return miVbbks1Q6ai3oKXPSyTCaRUVcybHYmHQT`, () => {
          assert.strictEqual(actual, 'miVbbks1Q6ai3oKXPSyTCaRUVcybHYmHQT');
        });
        try {
      ...
      context('With bech32 format', () => {
        const actual = instanceWithTestnet.getAddressFromPublic(publicKey, 'bech32');
        it(`should be return tb1qyzn2ltksd54s623q2f68qg6l5uv5qpvxdmqs8z`, () => {
          assert.strictEqual(actual, 'tb1qyzn2ltksd54s623q2f68qg6l5uv5qpvxdmqs8z');
        });
      })

      context('With invalid format', () => {
        const actual = instanceWithTestnet.getAddressFromPublic(publicKey, 'invalid');
        it(`should be return miVbbks1Q6ai3oKXPSyTCaRUVcybHYmHQT`, () => {
          assert.strictEqual(actual, 'miVbbks1Q6ai3oKXPSyTCaRUVcybHYmHQT');
        });
      })
  ...
  describe('#checkSign', () => {
    ...
    context('with testnet network', () => {
      const actualPositive = instanceWithTestnet.checkSign('02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d', 'fake_data', '1fac94bc837983a6569d42a46e6fa5156c2b23b3be9d4c90e1a68f804ed85d6e6b31b044f4b2eac5853d91d29e04bbb9f2f7b4d2a3465fe2ad2a0181abd345ca');
      it('should be return `true`', () => {
        assert.strictEqual(actualPositive, true);
      });
      try {
        instanceWithTestnet.checkSign('Invalid_Public_Key', 'fake_data', '1fac94bc837983a6569d42a46e6fa5156c2b23b3be9d4c90e1a68f804ed85d6e6b31b044f4b2eac5853d91d29e04bbb9f2f7b4d2a3465fe2ad2a0181abd345ca'); // check behavior in case of invalid public Key
      } catch (ex) {
        it('should be throw an error with following message `Expected isPoint, got Buffer`', () => {
          assert.strictEqual(ex.message, 'Expected isPoint, got Buffer');
        });
      ...
      try {
        instanceWithTestnet.checkSign('02c32badd397806e72c44279e673bb592394124ea28198fb0e514261a1a275229d', 'fake_data', 'invalid_sign');
      } catch (ex) {
        it('should be throw an error with following message `Expected Signature`', () => {
          assert.strictEqual(ex.message, 'Expected Signature');
        });
